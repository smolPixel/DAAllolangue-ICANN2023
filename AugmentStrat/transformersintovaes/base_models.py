...
from AugmentStrat.transformersintovaes.datamodule_finetune import LineByLineDataset
from AugmentStrat.transformersintovaes.datamodule_finetune_category import CategoryFinetuneDataset
from AugmentStrat.transformersintovaes.datamodule_pretrain import WikiDataset
from AugmentStrat.transformersintovaes.model_t5 import T5VAE
...
datasets = {
    ...
    "Current1K": {
        "dataset_class": LineByLineDataset,
        "train_file": "data/optimus/current/train.txt",
        "validate_file": "data/optimus/current/valid.txt",
        "test_file": "data/optimus/current/test.txt",
