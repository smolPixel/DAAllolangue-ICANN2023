...
def initialize_dataset_pretraining(argdict, language):
	...
	if language in ['fr']:
		from data.PretrainDataset import Pretrain_dataset
		#Textual dataset


		train=pd.read_csv(f'/data/rali6/Tmp/piedboef/Models/DACon/fr_pretraining.tsv', sep='\t', index_col=0)
		if argdict['tokenizer']=='PtweetTokenizer':
			try:
				...
				vocab = build_vocab_from_iterator((iter([tokenizer.tokenize(sentence.lower()) for sentence in list(train['sentence'])])),specials=["<unk>", "<pad>", "<bos>", "<eos>"], max_tokens=50000)
				vocab.set_default_index(vocab["<unk>"])
				with open(f'/data/rali6/Tmp/piedboef/Models/DACon/{language}_vocab.pickle', 'wb') as f:
					pickle.dump(vocab, f)
				print("builded pretraining vocab")
		else:
		...
		train=Pretrain_dataset(train, tokenizer, vocab, argdict)
		...
		train=pd.read_csv(f'/data/rali6/Tmp/piedboef/Models/DACon/de_pretraining.tsv', sep='\t', index_col=0)
		if argdict['tokenizer'] == 'PtweetTokenizer':
			try:
				with open(f'/data/rali6/Tmp/piedboef/Models/DACon/{language}_vocab.pickle', 'rb') as f:
					vocab = pickle.load(f)
				...
				vocab = build_vocab_from_iterator(
					(iter([tokenizer.tokenize(sentence.lower()) for sentence in list(train['sentence'])])),
					specials=["<unk>", "<pad>", "<bos>", "<eos>"], max_tokens=50000)
				vocab.set_default_index(vocab["<unk>"])
				with open(f'/data/rali6/Tmp/piedboef/Models/DACon/{language}_vocab.pickle', 'wb') as f:
					pickle.dump(vocab, f)
				print("builded pretraining vocab")
		...
		train=pd.read_csv(f'/data/rali6/Tmp/piedboef/Models/DACon/ko_pretraining.tsv', sep='\t', index_col=0)
		if argdict['tokenizer']=='PtweetTokenizer':
			try:
				with open(f'/data/rali6/Tmp/piedboef/Models/DACon/{language}_vocab.pickle', 'rb') as f:
					vocab=pickle.load(f)
		...
		train=pd.read_csv(f'/data/rali6/Tmp/piedboef/Models/DACon/sw_pretraining.tsv', sep='\t', index_col=0)
		if argdict['tokenizer']=='PtweetTokenizer':
			try:
				with open(f'/data/rali6/Tmp/piedboef/Models/DACon/{language}_vocab.pickle', 'rb') as f:
					vocab=pickle.load(f)
